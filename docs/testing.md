...
| --- | ---: | --- |
| standalone | 1284 | all component tests outside the provider-contract/simulation, egress, and family partitions; every selected identity executes with zero skipped, including the explicitly feature-enabled verifier fixture tests |
...
| total | 1330 | exact union of the four disjoint partitions above |
...
| Lane | Scope |
| --- | --- |
| `fast` | exactly 1284 standalone nextest identities, all executed with zero skipped |
