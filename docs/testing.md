...
| --- | ---: | --- |
| standalone | 1266 | all component tests outside the provider-contract/simulation, egress, and family partitions; every selected identity executes with zero skipped, including the explicitly feature-enabled verifier fixture tests |
...
| total | 1312 | exact union of the four disjoint partitions above |
...
| Lane | Scope |
| --- | --- |
| `fast` | exactly 1266 standalone nextest identities, all executed with zero skipped |
