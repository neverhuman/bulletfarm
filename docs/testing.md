...
| --- | ---: | --- |
| standalone | 1288 | all component tests outside the provider-contract/simulation, egress, and family partitions; every selected identity executes with zero skipped, including the explicitly feature-enabled verifier fixture tests |
...
| total | 1334 | exact union of the four disjoint partitions above |
...
| Lane | Scope |
| --- | --- |
| `fast` | exactly 1288 standalone nextest identities, all executed with zero skipped |
