...
| WP-02 | P0 | V1 | V1-S1 through V1-S4 | Kernel, Runner, Verifier, BulletGit, Effects | Connected public-command/Runner component with unsigned fixture receipt and durable UNKNOWN; independent transaction proof remains absent | Signed `TRANSACTION_PROOF` for one exact offline five-plane transaction, followed by a matched receipt-bearing benchmark corpus | IN PROGRESS |
