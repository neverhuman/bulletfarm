...
assert(
  read("ops/ci/fast.sh").includes(
    'assert-report.mjs vitest "$reports/vitest.json" 153',
  ),
  "exact 153-test Vitest count ratchet absent",
);
assert(
  read("ops/ci/fast.sh").includes(
    "081182b3d3c9bcdd662e1b079e0c51d89509822569eeb569ed21762756d9a0a2",
